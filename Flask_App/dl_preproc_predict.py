"""dl_preproc_predict.py: This program provides the preprocessing facility for the Fake News Detection DL model.

    Various functions are provided to prepare the data for preprocessing, including:
        -twitter_cleaning: removes Twitter specific data such as URLs, Twitter handles and hashtags
        -general_cleanup: removes non-ASCII characters, HTML entities and additional spaces created during preprocessing preparation
        -spacy_preproc: enables the preprocessing of the Tweet using the spaCy libraries
        -preprocmain: the main function for this program. Controls the I/O and flow of program execution
"""
__author__      = "Breydon Verryt-Reid"
__date__        = "28 Sep 22"
__Version__     = 2.0
__status__      = "Complete"
__notes__       = "This program is to be driven from the dl_backend_predict.py program"
